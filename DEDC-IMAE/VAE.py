...
if __name__ == "__main__":
    ...
    for t in range(4):  # time:1-4
        ...
        # datapath = 'BBC/BBCtime{}.txt'.format(item)
        # label_path = 'BBC/BBCtime{}_label.txt'.format(item)
        ...
        # 使用K-means进行聚类
        kmeans = KMeans(n_clusters=5, n_init=30, random_state=42).fit(latent_vectors)
